...
%>
   <%
    ...
    <div class="article">
            ...
            <br/><br/><br/><br/>
            <center>
                <h2><font color="red">Search a Tweet with Keyword</font></h2>
         <br/>
        <form name="myform" action="searchtweetsact.jsp" method="post">
        <table border="0" >

            <tr><td><font color="black">Tweet Keyword :</td><td><input type="text" name="keyword" required="" /></td></tr>
