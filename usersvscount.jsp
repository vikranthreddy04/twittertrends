    ...
    <div class="article">
       ...
       <p align="justify"> 
        ...
        <%@ include file="connect.jsp" %>
           ...
           <form action="usersvscountact.jsp" method="post">
              <%
                             	
String sql="SELECT distinct topic FROM commentscount  ";
...
String sql1="SELECT distinct dt FROM commentscount  ";
...
%>
           <label for="dt">Select Time: </label>
            ...
            <br/>        <br/>
        <input type="submit" class="submit_btn" name="submit" id="submit" value="View Graph" />
