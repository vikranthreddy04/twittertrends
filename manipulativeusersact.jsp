...
String sql="SELECT * FROM timecount where topic='"+topic+"' order by count1 desc ";
...
if(rs.next()){
   dt = rs.getString("dt");
   System.out.println("dateee"+dt);
}

String sql1="SELECT dt,rank1,username FROM commentscount where dt='"+dt+"' order by rank1 desc ";
...
ResultSet rs1 =st1.executeQuery(sql1); 
 ...
 if(rs1.next()){
   ...
   System.out.println("unameeee"+username);
}
%>

<h2><font color="black" size="5"> View Manipulative Users</font></h2>
        <br>
                    <table border="2" width="80%">

                            <tr style="background-color: skyblue">
                                <td><font color="black">User Name</font></td>
                            <td><font color="black">Topic</font></td>
                            <td><font color="black">Block User</font></td>
    ...
    <tr>
        <td><font color="black"><%=username%></font></td>
         <td><font color="black"><%=topic%></font></td>
         <td><a href="blockusers.jsp?username=<%=username%>">Block</a></td>
         </tr>
