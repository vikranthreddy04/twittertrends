...
<body>
       ...
       <script>alert('Friend Reques sent Sucessfully');</script>
       <%}%>
       <%
       if (request.getParameter("m2") != null) {%>
       <script>alert('Friend Request Already Sent');</script>
       <%}%>
   ...
   <%
    ...
    <div class="article">
            ...
            <br/><br/><br/><br/>
                ...
                <center><p><font color="red" size="5" >Search Friend </font></p></center>
                <br/>
                <center>
        <form name="myform" action="searchfriendact.jsp" method="post">
        <table border="0" >

            <tr><td><font color="black"> Name :</td><td><input type="text" name="username" required="" /></td></tr>
