...
<%@page	import="java.util.*,java.text.SimpleDateFormat,java.util.Date,java.io.FileInputStream,java.io.FileOutputStream,java.io.PrintStream"%>
    ...
    String s1,s2,s3,s4;
      ...
      String sql2="select * from tweets where username = '"+user+"' "; 
	...
	while(rs1.next())
	{
		...
		s3=rs1.getString(5);
           if(m==0){
            ...
            <td  width="115" valign="baseline" height="0" style="color: #2c83b0;"><div align="center"><strong>Description </strong></div></td>
