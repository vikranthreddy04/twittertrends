...
<body>
    ...
    <%
        try {
       PreparedStatement ps = connection.prepareStatement("select * from friendrequest where uname='"+user+"' and status='Accepted'");
        ResultSet rs1 = ps.executeQuery();

    %>
    <br><br>
    <center>
        <h2><font color="black" size="5"> Friends List</font></h2>
        <br>
                    <table border="2" width="80%">

                        <tr style="background-color: skyblue">
                            <td><font color="black">Friend Name</td>
